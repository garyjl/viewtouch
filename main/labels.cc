...
genericChar *FontName[] = {
    "Page Default", "Helv 14", "Helv 14 Bold", "Helv 18", "Helv 18 Bold",
    "Helv 20", "Helv 20 Bold", "Helv 24", "Helv 24 Bold",
    "Helv 34", "Helv 34 Bold", "Courier 18", "Courier 18 Bold",
    "Courier 20", "Courier 20 Bold", NULL};
int FontValue[] = {
    FONT_DEFAULT, FONT_HELV_14, FONT_HELV_14B, FONT_HELV_18, FONT_HELV_18B,
    FONT_HELV_20, FONT_HELV_20B, FONT_HELV_24, FONT_HELV_24B,
    FONT_HELV_34, FONT_HELV_34B, FONT_COURIER_18, FONT_COURIER_18B,
